...
export default function HomeInterviewSection() {
  return (
    <section className="min-h-screen bg-gradient-to-b from-[#c8b5ff] via-[#b8c5ff] to-[#a8d5ff] flex items-center py-12">
      <div className="max-w-7xl mx-auto w-full px-6 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
          ...
          <h2 className="text-white text-4xl md:text-6xl font-extrabold leading-tight drop-shadow-md">
            모야? AI 모의 면접이야!
          </h2>
          ...
          <div className="pt-6 flex justify-center lg:justify-end">
            <Button className="bg-[#2b7fff] hover:bg-blue-500 text-white px-6 py-4 md:py-6 text-lg md:text-xl font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-200">
              <Link to="/interview/start">AI 모의 면접 시작하기</Link>
            </Button>
          </div>
        </div>
      </div>
