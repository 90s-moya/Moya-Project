  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 font-['Pretendard']">
      ...
      <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute right-20 top-60 w-32 h-32 bg-blue-200/30 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }} />
        <div className="absolute left-20 bottom-40 w-24 h-24 bg-indigo-200/30 rounded-full animate-bounce" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <main className="mx-auto max-w-6xl px-6 md:px-8 py-20 md:py-28">
        <section className="grid gap-12 md:grid-cols-2 md:items-center">
          ...
          <div className="mx-auto w-full max-w-lg animate-fade-in-up" style={{ animationDelay: '1s' }}>
            <div className="relative group">
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full animate-bounce shadow-lg" style={{ animationDelay: '0.3s' }} />
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full animate-bounce shadow-lg" style={{ animationDelay: '0.7s' }} />
              ...
              <div className="relative rounded-3xl border border-slate-200/60 bg-white/90 backdrop-blur-sm shadow-2xl shadow-slate-200/50 transform transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-blue-200/50">
                <div className="p-5 border-b border-slate-100/60">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="h-3 w-3 rounded-full bg-yellow-400 animate-pulse" style={{ animationDelay: '0.2s' }} />
                ...
                <div className="p-8">
                  <div className="relative h-56 rounded-2xl bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 border border-slate-200/60 overflow-hidden backdrop-blur-sm">
                    ...
                    <div className="absolute inset-x-0 bottom-3 flex items-center justify-center gap-4">
                      ...
                      <div className="h-8 w-8 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 shadow-lg animate-pulse" style={{ animationDelay: '0.5s' }} />
                    </div>
                  </div>
                  ...
                  <div className="mt-6 space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-semibold text-slate-700">진행 흐름</span>
                      <span className="text-xs text-slate-500 bg-slate-100 px-2 py-1 rounded-full">질문 → 꼬리질문1 → 꼬리질문2</span>
                    </div>
                    <div className="h-3 w-full rounded-full bg-slate-100 overflow-hidden shadow-inner">
                      <div className="h-full bg-gradient-to-r from-blue-400 via-indigo-500 to-cyan-500 rounded-full transition-all duration-1000 ease-out animate-progress" style={{ width: '33.33%' }} />
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              {[
                { text: "서류 기반 맞춤 질문", icon: "📄", color: "from-blue-500 to-blue-600" },
                { text: "최대 1분 답변", icon: "⏱️", color: "from-indigo-500 to-indigo-600" },
                { text: "자연스러운 대화 흐름", icon: "💬", color: "from-cyan-500 to-cyan-600" },
                { text: "AI 면접관 모야", icon: "🤖", color: "from-blue-400 to-indigo-500" }
              ].map((item, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${item.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300`} />
                </div>
              ))}
            </div>
          </div>
