      ...
      <div className="w-full max-w-[880px] h-[360px] bg-[#FAFAFC] border border-[#EFEFF3] rounded-[10px] flex flex-col items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <p className="text-[#1B1C1F] font-semibold text-lg mb-1">
              {uploadedFile.name}
            </p>
            <p className="text-[#6F727C] text-sm">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <p className="text-[#1B1C1F] font-semibold text-lg mb-2">
            {getTypeText(type)} 파일을 업로드하세요
          </p>
          <p className="text-[#6F727C] text-sm mb-1">
            파일을 드래그해서 놓거나 클릭해서 선택하세요
          </p>
          <p className="text-[#989AA2] text-xs">
            지원 형식: PDF (최대 {maxSize}MB)
          </p>
        </div>

        {/* 등록 버튼 */}
        <button className="bg-[#2B7FFF] hover:bg-[#1E6FE8] text-white px-6 py-3 rounded-[10px] text-sm font-semibold transition-colors">
          {getTypeText(type)} 등록하기
        </button>
      </div>
