        ...
        <div>
          ...
          <div className="bg-white p-4 rounded-lg border border-[#dedee4] shadow-sm">
            {verbal_result.answer ? (
              ...
              <p className="text-sm text-gray-500 italic">답변이 기록되지 않았습니다.</p>
            )}
          </div>
        </div>

                                 {/* 분석 결과 */}
         {verbal_result.end_type && verbal_result.stopwords && verbal_result.is_ended !== undefined && 
          verbal_result.context_matched !== undefined && verbal_result.speech_label && verbal_result.syll_art && verbal_result.gpt_comment ? (
          <div>
          ...
          <div>
            ...
            <div className="bg-white p-4 rounded-lg border border-[#dedee4] shadow-sm">
              <p className="text-sm text-gray-500 italic text-center">분석 결과가 없습니다.</p>
            </div>
          </div>
        )}
      </div>
